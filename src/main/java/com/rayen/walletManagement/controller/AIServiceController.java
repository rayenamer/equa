...
public class AIServiceController {
    ...
    @Operation(summary = "Predictions par lot",
            description = "Envoie plusieurs clients au modele IA pour des predictions groupees. Body: { \"customers\": [ {...}, {...} ] }")
    public ResponseEntity<?> predictBatch(@RequestBody Map<String, Object> batchData) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_JSON);
